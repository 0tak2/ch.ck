...
const Header = (0, import_index_58de3ccc.c)(($$result, $$props, $$bindings, slots) => {
...
const _layout = (0, import_index_58de3ccc.c)(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `${(0, import_index_58de3ccc.v)(Header, "Header").$$render($$result, {}, {}, {})}
